...
% Defino filtro limites de corte de valores de modulo de Young y fuerza maxima de adhesion:
...
minAc = 0; % Limite minimo de fuerza maxima de adhesion del grupo control
maxAc = 0.01; % Limite maximo de fuerza maxima de adhesion del grupo control
minAm = 0; % Limite minimo de fuerza maxima de adhesion del grupo modificado
maxAm = 0.01; % Limite maximo de fuerza maxima de adhesion del grupo modificado

% Defino limite superior de ejes de histograma y boxplot:
limE = 100; % Modulo de Young
limA = 0.01; % Fuerza maxima de adhesion
