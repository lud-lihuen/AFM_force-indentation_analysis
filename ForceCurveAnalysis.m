%% Force curve analysis - Young's Modulus - Work of Adhesion
...
E = E(re>=0.99&E>0); % Vector solo con los E positivos con coeficiente de correlacion mayor a 0.99
A = A(ra>=0.99&A>0); % Vector solo con los A positivos con coeficiente de correlacion mayor a 0.99
